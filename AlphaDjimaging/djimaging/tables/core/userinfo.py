...
class UserInfoTemplate(dj.Manual):
    ...
    def definition(self):
        ...
        condition_loc                   :tinyint       # string location for (pharmacological) cond1
        opticdisk_alias='od_opticdisk'  :varchar(191)  # alias(es) for optic disk recordings (separated by _)
