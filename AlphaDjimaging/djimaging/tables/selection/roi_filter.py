...
class CellFilterParamsTemplate(dj.Lookup):
    ...
    def definition(self):
        ...
        cond1 = 'control'           :  varchar(191)        # Condition to classify. Empty strings = all conditions. 
        """
        return definition

    def add_parameters(self, cond1: str, qi_thres_chirp: float, qi_thres_bar: float,
                       cell_selection_constraint: str, skip_duplicates: bool = False) -> None:
        insert_dict = dict(qi_thres_chirp=qi_thres_chirp, qi_thres_bar=qi_thres_bar, cond1=cond1,
