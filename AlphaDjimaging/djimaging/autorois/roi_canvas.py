...
class RoiCanvas:
    ...
    def compute_backgrounds(self):
        ...
        backgrounds = {
            'stack: ch0[mean]': self.compute_bg(self.ch0_stacks[stim_idx], shift, proj_fun=np.nanmean),
            'stack: ch0[std]': self.compute_bg(self.ch0_stacks[stim_idx], shift, proj_fun=np.nanstd),
            'stack: ch1[mean]': self.compute_bg(self.ch1_stacks[stim_idx], shift, proj_fun=np.nanmean),
            'stack: ch1[std]': self.compute_bg(self.ch1_stacks[stim_idx], shift, proj_fun=np.nanstd),
